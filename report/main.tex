...
\section{Introduction}
    ...
    \begin{figure}[!tbh]
        \centering
        \includegraphics[width=0.99\linewidth]{img/arXiv_search_example.png}
    ...
    \begin{figure}[!tbh]
        \centering
        \includegraphics[width=0.99\linewidth]{img/google_search_example.png}
    ...
    \begin{figure}[!tbh]
        \centering
        \includegraphics[width=0.99\linewidth]{img/advanced_google_search_example.png}
